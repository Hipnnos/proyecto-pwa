    ...
    <Flex direction="column" alignSelf="center" justifySelf="center" overflow="hidden">
      ...
      <Flex direction="column" textAlign="center" justifyContent="center" align="center" mt="6.5rem" mb="30px">
        ...
        <Text fontSize="md" color="white" fontWeight="normal" mt="10px" mb="26px" w={{ base: "90%", sm: "60%", lg: "40%", xl: "30%" }}>
          Mucho más que un rastreo satelital. Trabajamos por usted. Siempre atentos a tus necesidades
        </Text>
      </Flex>
      <Flex alignItems="center" justifyContent="center" mb="60px" mt="20px">
        <Flex direction="column" w="445px" background="transparent" borderRadius="15px" p="40px" mx={{ base: "100px" }} bg={bgColor} boxShadow="0 20px 27px 0 rgb(0 0 0 / 5%)">
          ...
          <FormControl>
            ...
            <Input fontSize="sm" ms="4px" borderRadius="15px" type="text" placeholder="Tu nombre completo" mb="24px" size="lg"/>
            <FormLabel ms="4px" fontSize="sm" fontWeight="normal">
              Correo
            </FormLabel>
            <Input fontSize="sm" ms="4px" borderRadius="15px" type="email" placeholder="Tu correo electrónico" mb="24px" size="lg"/>
            <FormLabel ms="4px" fontSize="sm" fontWeight="normal">
              Contraseña
            </FormLabel>
            <Input fontSize="sm" ms="4px" borderRadius="15px" type="password" placeholder="Tu contraseña" mb="24px" size="lg"/>
            ...
            <Button type="submit" bg="blue.500" fontSize="10px" color="white" fontWeight="bold" w="100%" h="45" mb="24px" _hover={{bg: "teal.200",}} _active={{bg: "teal.400",}}>
              REGISTRARSE
            </Button>
          </FormControl>
